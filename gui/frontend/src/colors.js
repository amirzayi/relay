...
export const gradientBgRedSilver = `${gradientBgBase} from-red-400 via-cyan-300 to-silver-300`;
export const gradientBgGreenCyan = `${gradientBgBase} from-green-300 via-silver-300 to-cyan-400`;
